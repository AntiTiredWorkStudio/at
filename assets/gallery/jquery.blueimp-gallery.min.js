...
function(a) {
	...
	"use strict";
	a(document).on("click", "[data-gallery01]", function(c) {
		var d = a(this).data("gallery01"),
			e = a(d),
			f = e.length && e || a(b.prototype.options.container),
			g = {
				onopen: function() {
					f.data("gallery01", this).trigger("open")
				},
				onopened: function() {
					f.trigger("opened")
				},
				...
				onclosed: function() {
					f.trigger("closed").removeData("gallery5")
				}
			},
			h = a.extend(f.data(), {
				container: f[0],
			...
			i = a('[data-gallery01="' + d + '"]');
		return h.filter && (i = i.filter(h.filter)), new b(i, h)
	});
	a(document).on("click", "[data-gallery02]", function(c) {
		var d = a(this).data("gallery02"),
			e = a(d),
			f = e.length && e || a(b.prototype.options.container),
			g = {
				onopen: function() {
					f.data("gallery02", this).trigger("open")
				},
				onopened: function() {
					f.trigger("opened")
				},
