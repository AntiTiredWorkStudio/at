var G = function(){!function(a) {
	...
	"use strict";
		...
		setTimeout(function(){
	$("[gallery]").each(function(iIndex,gElement){
		
		
		console.log(iIndex,$(gElement).attr("gallery"));
		
		var ic = $(gElement).attr("gallery");
		
		$(gElement).attr("href",$(gElement).attr("shref"));
		$(gElement).attr("shref",null);
		$(gElement).attr("onclick",null);
		
		//console.log($(gElement).attr("shref"));
		
		a(document).on("click", "[data-gallery"+ic+"]", function(c) {
		var d = a(this).data("gallery"+ic),
			e = a(d),
			f = e.length && e || a(b.prototype.options.container),
			g = {
				onopen: function() {
					f.data("gallery"+ic, this).trigger("open")
				},
				onopened: function() {
					f.trigger("opened")
				},
				...
				onclosed: function() {
					f.trigger("closed").removeData("gallery"+ic)
				}
			},
			h = a.extend(f.data(), {
				container: f[0],
